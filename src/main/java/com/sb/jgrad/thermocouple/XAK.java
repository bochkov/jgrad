...
public final class XAK extends Thermocouple {
    ...
    public String description() {
        return "Номинальная статическая характеристика преобразования термопары типа ТХА(K) { никель-хром/никель-алюминий (хромель/алюмель) }";
    }
    ...
    public double value(double temp) throws OutOfBoundException {
        ...
        if (temp >= -200 && temp < 0) {
            ...
            throw new OutOfBoundException("temp is out of bounds [-270..1372]");
    ...
    public double temp(double v) throws OutOfBoundException {
        ...
        if (v >= -5.891 && v < 0)
            ...
            c = new double[]{-1.318058e2, 4.830222e1, -1.646031,
                    5.464731e-2, -9.650715e-4, 8.802193e-6, -3.110810e-8};
        else
            throw new OutOfBoundException("value is out of bounds [-5.891..54.886]");
